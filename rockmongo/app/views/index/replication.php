...
<table bgcolor="#cccccc" cellpadding="2" cellspacing="1" width="600">
	<tr>
		<th colspan="2"><?php hm("me"); ?> (<a href="<?php h(url("collection", array( "db" => "local", "collection" => "me" ))); ?>">local.me</a>)</th>
	</tr>
...
<table bgcolor="#cccccc" cellpadding="2" cellspacing="1" width="600">
	<tr>
		<th colspan="2"><?php hm("slaves"); ?> (<a href="<?php h(url("collection", array( "db" => "local", "collection" => "slaves" ))); ?>">local.slaves</a>)</th>
	</tr>
...
<table bgcolor="#cccccc" cellpadding="2" cellspacing="1" width="600">
	<tr>
		<th colspan="2"><?php hm("masters"); ?> (<a href="<?php h(url("collection", array( "db" => "local", "collection" => "sources" ))); ?>">local.sources</a>)</th>
	</tr>
