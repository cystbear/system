...
<div class="operation">
	...
	<a href="<?php h(url("profileLevel", array("db"=>$db))); ?>" class="current"><?php hm("change_level"); ?></a> | 
	<a href="<?php h(url("clearProfile", array("db"=>$db))); ?>" onclick="return window.confirm('<?php hm("clear_profile"); ?> \'<?php h($db); ?>\'?')"><?php hm("clear"); ?></a> 
</div>
